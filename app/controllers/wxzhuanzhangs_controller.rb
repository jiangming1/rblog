  ...
  def update
    respond_to do |format|
      if @wxzhuanzhang.update(wxzhuanzhang_params)
        ...
        @run=`convert /root/opt/rblog/public/a/wxzhuanzhang.png -font /root/opt/rblog/public/a/msyh.ttc  -fill  'rgb(255,255,255)' -pointsize 40 -annotate +364+438 "￥#{wxzhuanzhang_params[:jin]}" -font /root/opt/rblog/public/a/msyh.ttc  -fill  'rgb(255,255,255)' -pointsize 40 -annotate +438+911 "￥#{wxzhuanzhang_params[:jin]}" -font /root/opt/rblog/public/a/msyh.ttc  -fill  'rgb(251,251,251)' -pointsize 34.5 -annotate +388+694 "#{date1}" -font /root/opt/rblog/public/a/msyh.ttc  -fill  'rgb(255,255,255)' -pointsize 50 -annotate +237+166 "#{wxzhuanzhang_params[:xingming]}"   /root/opt/rblog/public/#{id}.png`
